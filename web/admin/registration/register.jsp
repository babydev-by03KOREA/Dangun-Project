...
<body>
    ...
    <form action="${pageContext.request.contextPath}/admin/registration/registerPro.jsp" method="post">
        ...
        <div class="input-group mb-3">
            <input type="time" name="breaktime1" class="form-control" placeholder="등록할 맛집 BreakTime을 입력하세요.(없으면 입력X)" aria-label="Recipient's username">
        </div>
        <div class="time">
            맛집의 BreakTime의 끝나는시간을 시계 아이콘⏰을 눌러 선택해주세요!
        </div>
        <div class="input-group mb-3">
            <input type="time" name="breaktime2" class="form-control" placeholder="등록할 맛집 BreakTime을 입력하세요.(없으면 입력X)" aria-label="Recipient's username">
        </div>
